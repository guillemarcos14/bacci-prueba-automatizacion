...
| 23/09/2026 | Guardar por carga solo los campos operativos que cambian de cada caso | Permite explicar el efecto de un lote sin interpretar un cambio de orden o procedencia como trabajo nuevo; las cargas anteriores a la función indican que no disponen de comparación. |
| 23/09/2026 | Filtrar «Revisión humana» por la etiqueta calculada y conservarlo combinado con los demás filtros | Aísla datos dudosos con el mismo criterio que se muestra en el detalle, sin redefinir la prioridad. |
| 23/09/2026 | Mostrar todas las fechas activas incompatibles sin elegir la última por orden de llegada | El correo más reciente no implica rectificación; se conserva la urgencia de cualquier petición activa y se pide aclaración antes de confirmar un cambio. |
